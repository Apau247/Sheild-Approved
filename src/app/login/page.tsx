      ...
      <div className="mx-auto flex min-h-screen max-w-7xl items-center px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        <section className="grid w-full gap-10 lg:grid-cols-[0.95fr_0.75fr] lg:items-center">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8">Access protected asset records, secure movement updates and appointment details through the Iron Vault Security client portal.</p>
          </div>
